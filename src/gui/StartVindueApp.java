...
//        Pris prisFredagsbarJuletøndenMedKlip = Controller.createPrisMedKlip(70, fredagsbar);
//        Pris prisFredagsbarOldStrongAleMedKlip = Controller.createPrisMedKlip(70, fredagsbar);
//        Pris prisFredagsbarFregattenJyllandMedKlip = Controller.createPrisMedKlip(70, fredagsbar);
//        Pris prisFredagsbarImperialStoutMedKlip = Controller.createPrisMedKlip(70, fredagsbar);
//        Pris prisFredagsbarTributeMedKlip = Controller.createPrisMedKlip(70, fredagsbar, tribute);
//        Pris prisFredagsbarBlackMonsterMedKlip = Controller.createPrisMedKlip(100, fredagsbar, blackmonster);

        Pris prisFredagsbarFadølKlosterbrygMedKlip = Controller.createPrisMedKlip(38, fredagsbar, klosterbryg);
        Pris prisFredagsbarFadølJazzClassicMedKlip = Controller.createPrisMedKlip(38, fredagsbar, jazzclassic);
        Pris prisFredagsbarFadølExtraPilsnerMedKlip = Controller.createPrisMedKlip(38, fredagsbar, extrapilsner);
        Pris prisFredagsbarFadølCelebrationMedKlip = Controller.createPrisMedKlip(38, fredagsbar, celebration);
        Pris prisFredagsbarFadølBlondieMedKlip = Controller.createPrisMedKlip(38, fredagsbar, blondie);
        Pris prisFredagsbarFadølForårsbrygMedKlip = Controller.createPrisMedKlip(38, fredagsbar, forårsbryg);
        Pris prisFredagsbarFadølIndiaPaleAleMedKlip = Controller.createPrisMedKlip(38, fredagsbar, indiapaleale);
        Pris prisFredagsbarFadølJulebrygMedKlip = Controller.createPrisMedKlip(38, fredagsbar, julebryg);
        Pris prisFredagsbarFadølImperialStoutMedKlip = Controller.createPrisMedKlip(38, fredagsbar, imperialstout);
        Pris prisFredagsbarFadølSpecialMedKlip = Controller.createPrisMedKlip(38, fredagsbar, special);
        Pris prisFredagsbarFadølÆblebrus = Controller.createPris(15, fredagsbar, æblebrus);
        Pris prisFredagsbarFadølChips = Controller.createPris(10, fredagsbar, chips);
        Pris prisFredagsbarFadølPeanuts = Controller.createPris(15, fredagsbar, peanuts);
        Pris prisFredagsbarFadølCola = Controller.createPris(15, fredagsbar, cola);
